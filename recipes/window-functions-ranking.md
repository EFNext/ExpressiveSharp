...
This recipe shows how to use SQL window functions -- ROW\_NUMBER, RANK, DENSE\_RANK, and NTILE -- in EF Core LINQ queries via the `ExpressiveSharp.EntityFrameworkCore.RelationalExtensions` package.
