...
public class ExpressiveForTests : GeneratorTestBase
{
    ...
    // ── Synthesize snapshot tests ───────────────────────────────────────────

    [TestMethod]
    public Task Synthesize_ReferenceTypeTarget_EmitsCoalesceForm()
    {
        // Non-nullable reference target — coalesce shape.
        var compilation = CreateCompilation(
            """
            using ExpressiveSharp.Mapping;
    ...
    [TestMethod]
    public Task Synthesize_NullableReferenceTypeTarget_EmitsTernaryForm()
    {
        // Nullable reference target — ternary+flag shape (coalesce would fail for stored nulls).
        var compilation = CreateCompilation(
            """
            #nullable enable
            using ExpressiveSharp.Mapping;
    ...
    [TestMethod]
    public Task Synthesize_NonNullableValueTypeTarget_EmitsCoalesceForm()
    {
    ...
    [TestMethod]
    public Task Synthesize_NullableValueTypeTarget_EmitsTernaryForm()
    {
        // Nullable value target — ternary+flag shape (issue #35 scenario).
        var compilation = CreateCompilation(
            """
            #nullable enable
            using ExpressiveSharp.Mapping;
    ...
    [TestMethod]
    public void Synthesize_TargetAlreadyExists_ReportsEXP0031()
    {
        // Target name clashes with an existing member on the same type.
        var compilation = CreateCompilation(
            """
            using ExpressiveSharp.Mapping;
    ...
    [TestMethod]
    public void Synthesize_NonPartialContainer_ReportsEXP0032()
    {
        // Containing type is not partial — cannot emit the synthesized property into it.
        var compilation = CreateCompilation(
            """
            using ExpressiveSharp.Mapping;
    ...
    [TestMethod]
    public void Synthesize_WithTwoArgForm_ReportsEXP0033()
    {
        // Synthesize + two-arg form is invalid — Synthesize always targets the stub's own type.
        var compilation = CreateCompilation(
            """
            using ExpressiveSharp.Mapping;
